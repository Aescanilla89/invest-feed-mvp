...
import { ArrowLeft, Award, DollarSign, Rocket, Search, Sparkles, TrendingUp, Trophy, Zap } from "lucide-react";
...
const METHOD_META: Record<PortfolioMethod, { label: string; icon: React.ElementType; color: string }> = {
  ...
  featured: { label: "Destacada", icon: Sparkles, color: "text-(--color-accent)" },
};
