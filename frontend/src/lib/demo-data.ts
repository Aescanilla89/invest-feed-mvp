...
export const DEMO_CATALYSTS: Catalyst[] = [
  ...
  },
  {
    ...
    title: "Reunión FED: ¿Qué hará la Fed en julio?",
    description: "Recorte 25pb: 68% · Mantener: 24% · Recorte 50pb: 8%",
    detected_date: "2026-07-02",
    extra: {
      question: "¿Qué hará la Fed en julio?",
      end_date: "2026-07-29",
      outcomes: ["Recorte 25pb", "Mantener", "Recorte 50pb"],
      prices: [0.68, 0.24, 0.08],
      volume: 4820000,
  ...
  },
  {
    ...
    sector: null,
    catalyst_type: "fed_meeting",
    title: "Reunión FED: ¿Habrá 3 recortes de tipos en 2026?",
    description: "Sí: 55% · No: 45%",
    detected_date: "2026-07-01",
    extra: {
      question: "¿Habrá 3 recortes de tipos en 2026?",
      end_date: "2026-12-31",
      outcomes: ["Sí", "No"],
      prices: [0.55, 0.45],
      volume: 2140000,
      url: "https://polymarket.com/event/fed-three-cuts-2026",
    },
    combined_score: null,
    classification: null,
    explanation: null,
  },
  {
    ...
    title: "¿Habrá un alto el fuego confirmado antes de septiembre?",
    description: "Sí: 37%",
    detected_date: "2026-07-02",
    extra: {
      question: "¿Habrá un alto el fuego confirmado antes de septiembre?",
      end_date: "2026-09-01",
      outcomes: ["Sí", "No"],
      prices: [0.37, 0.63],
      volume: 6310000,
      url: "https://polymarket.com/event/ceasefire-september-2026",
    },
    combined_score: null,
    classification: null,
    explanation: null,
  },
  {
    ...
    sector: null,
    catalyst_type: "geopolitical",
    title: "¿Nuevos aranceles a China antes de octubre?",
    description: "Sí: 61%",
    detected_date: "2026-06-30",
    extra: {
      question: "¿Nuevos aranceles a China antes de octubre?",
      end_date: "2026-10-01",
      outcomes: ["Sí", "No"],
      prices: [0.61, 0.39],
      volume: 1870000,
      url: "https://polymarket.com/event/china-tariffs-october-2026",
    },
    combined_score: null,
    classification: null,
    explanation: null,
